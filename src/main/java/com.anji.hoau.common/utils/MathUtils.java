...
public class MathUtils {
    ...
    public static BigDecimal n100=new BigDecimal(100);

    public static Long divideGetLong(Long v1, BigDecimal v2, Integer scale) {
        return divideGetLong(new BigDecimal(MoneyUtil.getShowValue(v1)),v2,scale);
    }

    public static Long divideGetLong(Long v1, Long v2, Integer scale) {
       return divideGetLong(new BigDecimal(MoneyUtil.getShowValue(v1)),new BigDecimal(MoneyUtil.getShowValue(v2)),scale);
    }
    public static Long divideGetLong(BigDecimal v1, BigDecimal v2, Integer scale) {
        BigDecimal b=scale==2?n100:new BigDecimal(Math.pow(10, scale));
        return  divideGetBigDecimal(v1,v2,scale).multiply(b).longValue();
    }

    public static BigDecimal divideGetBigDecimal(BigDecimal v1, BigDecimal v2, Integer scale) {
        if (null == v1) {
            return BigDecimal.ZERO;
        }
        if (null == v2) {
     ...
     * @return
     */
    public static Double adjusDoubleAccuracy(Double data, int digit) {
        if (null != data) {
    ...
    public static double add(double value1, double value2 , int scale) {
        BigDecimal b1 = BigDecimal.valueOf(value1).setScale(scale);
        BigDecimal b2 = BigDecimal.valueOf(value2).setScale(scale);
     ...
     */
    public static List<String> subtractList(List<String> listOne, List<String> listTwo) {
