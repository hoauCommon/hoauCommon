package com.anji.hoau.common.enums;

import com.anji.hoau.common.model.ResponseModel;
...
public enum RepCodeEnum {
    ...
    USER_PASSWORD_TOO_EASY("1238", "密码过于简单，必须同时包含数字，字母，特殊（!@#$%^&*_-）符号"),
    /**=========================== 1xxxx base服务开始 ===================================*/
    /** 1001 - 1099 权限业务应答码 */
    ...
    USER_PASSWORD_ERROR("1207", "用户或密码错误"),
